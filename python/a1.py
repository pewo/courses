...
def get_hours(seconds):
    ...
    (You should call to_24_hour_clock to convert the number
    of full hours to a time on a 24 hour clock.
...
def get_minutes(seconds):
    ...
    as seen on a clock.
    (This means that the return value should be in the range 0 to 59,
    inclusive.) '''
...
def get_seconds(seconds):
    ...
    as seen on a clock. (This means that the return value should
    be in the range 0 to 59, inclusive.) '''
    hours = seconds // 3600
    left = seconds - hours * 3600
